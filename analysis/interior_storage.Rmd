...
```{r read_GLODAP_climatology, fig.asp=0.5}
...
for (i_basin_AIP in unique(GLODAP_predictors_zonal$basin_AIP)) {
  for (i_layer in c("surface", "deep")) {
    ...
    pdf(here::here(
      paste0(
        "output/Fig5_zonal_mean_sections/Fig5_section_",
        i_basin_AIP,
        "_",
        i_layer,
        ".pdf"
...
#                           breaks = c(seq(0, 70, 10), Inf),
#                    col = "black") +
#       geom_text_contour(aes(lat, depth, z = Cant_mean),
#                           breaks = c(seq(0, 70, 10), Inf),
#                         stroke = 0.3, rotate = FALSE)
#     
#     if (i_layer == "surface") {
#       p_sub <- p_all +
#         scale_y_reverse(breaks = seq(0, 500, 100),
...
#     
#     pdf(here::here(
#       paste0("output/Fig5_zonal_mean_sections/Fig5_Cant_",
#              i_basin_AIP,
#              "_",
#              i_layer,
#              ".pdf")
